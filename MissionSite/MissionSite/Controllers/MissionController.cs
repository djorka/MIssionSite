...
namespace MissionSite.Controllers
{
    public class MissionController : Controller
    {
        List<Mission> model = new List<Mission>
        {
            ...
            new Mission("Brazil Maceió", "Mark W. Taylor", "Av. Santa Rita de Cassia, 287 <br /> Educação Maceió Work Center <br />Farol, Maceió - AL <br />CEP f57051-600", "Portuguese", "Maceió has a typical tropical climate, specifically a tropical monsoon climate, with very warm to hot temperatures and high relative humidity all throughout the year.", "Catholicism", "~/Content/Images/brazilFlag.png")
        };
